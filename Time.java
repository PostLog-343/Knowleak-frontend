/*
    ...
    Copyleft (c) 1993 by C and System Programmers Asscociation (CSD)
    All Rights Free
 */
...
public class Time {
    ...
    private static void doWorkForException(String message)
    {
        ...
        System.exit(1); //It will change while we learn exception topic.
    }

    private static boolean isValidForBounds(int val, int bound)
    {
